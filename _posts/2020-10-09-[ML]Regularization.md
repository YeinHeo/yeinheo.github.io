...
![Untitled%201.png](/assets/img/20-10-09/Regularization/Untitled%201.png){: width="450" height="200"}
...
2. Regularization
    ...
    ![Untitled%202.png](/assets/img/20-10-09/Regularization/Untitled%202.png){: width="400" height="300"}
...
- Cost Function(=Loss Function) : How fit the line to our (training) data
    ...
    ![Untitled%203.png](/assets/img/20-10-09/Regularization/Untitled%203.png){: width="300" height="70"}


# Regularization

![Untitled%204.png](/assets/img/20-10-09/Regularization/Untitled%204.png){: width="400" height="100"}

![Untitled%205.png](/assets/img/20-10-09/Regularization/Untitled%205.png){: width="400" height="100"}
...
- 또한 λ의 값을 잘 선택하는 것이 중요하다.
    ...
    ![Untitled%206.png](/assets/img/20-10-09/Regularization/Untitled%206.png){: width="200" height="100"}
...
- 미분 과정
    ...
    ![Untitled%207.png](/assets/img/20-10-09/Regularization/Untitled%207.png){: width="400" height="100"}
...
- Gradient descent
    ...
    ![Untitled%208.png](/assets/img/20-10-09/Regularization/Untitled%208.png){: width="400" height="100"}

    세타j의 값은 1보다 작은 값을 계속 곱하므로 점점 작아지게 된다. 따라서 위의 과정을 통해 정규화가 된다.

### Normal equation

![Untitled%209.png](/assets/img/20-10-09/Regularization/Untitled%209.png){: width="400" height="100"}

위의 식은 matrix의 오차제곱항을 나타낸다. matrix X는 m x (n+1)의 크기를 가진다.

normal equation을 사용하여 regularization을 하게 되면,

![Untitled%2010.png](/assets/img/20-10-09/Regularization/Untitled%2010.png){: width="400" height="200"}
